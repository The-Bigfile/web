...
import { ledgerComposeSiafund } from '../fixtures/ledgerComposeBigfund'
...
test('compose bigfund transaction with ledger wallet pre and post v2 fork allow height', async ({
  page,
  browserName,
}) => {
