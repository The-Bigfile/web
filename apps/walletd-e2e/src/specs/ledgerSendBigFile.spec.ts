...
import { ledgerComposeBigFile } from '../fixtures/ledgerComposeBigFile'
...
test('compose bigfile transaction with ledger wallet pre and post v2 fork allow height', async ({
  page,
  browserName,
}) => {
  ...
  await ledgerComposeBigFile(page, {
