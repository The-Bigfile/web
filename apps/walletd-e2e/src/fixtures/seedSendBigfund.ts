...
import { fillComposeTransactionBigfund } from './sendBigfundDialog'
import { step } from '@siafoundation/e2e'

export const sendBigfundWithSeedWallet = step(
  'send bigfund with a seed wallet',
  async (
    page,
    {
      walletName,
    ...
    const feeString = `${expectedFee.toFixed(3)} BIG`
